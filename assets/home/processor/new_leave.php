...
$conn = $db_connection->dbConnection();
  ...
  if(empty($type)){
      ...
      $targetDir = "../../DOCUMENTS/staff_signature/";
  }else{


$targetDir = "../../DOCUMENTS/leave_letters/";
}
  ...
  $mail = new PHPMailer();
                   ...
                   $staff =     $_POST['staff'] ;
                     ...
                     $userEmail =     $_POST['staffEmail'] ;
                       $superEmail =     $_POST['superb'] ;

            if(empty($superEmail)){
                 $superEmail = "nmibrao@gmail.com";
                
            }
              
                 
                $dtlast_leave =    $_POST['last_leave'] ;
                  $dtStart =   $_POST['new_leave'] ;
                 $numdays = $_POST['n_days'] ;
                 $homeAddress =    $_POST['h_address'] ;
                 $houseNum =    $_POST['houseNum'] ;
                  $street_number =   $_POST['st_number'] ;
                 $district = $_POST['district'] ;
               $lcouncil =    $_POST['lcouncil'] ;
                  $state =   $_POST['state'] ;
                 $phone = $_POST['phone'] ;
        ...
        try{
                 ...
                 $insert_query = "INSERT INTO leave_request( staff_id, type, `date_last_leave`, `date_start_new`, `num_days`, `home_address`,house_number, `street_nameNumber`, `district`, `local_council`, `state`, `phone`, `officer_relieve`, `signature_path`  )VALUES(:staff_id,:type,
                :date_last_leave,:date_start_new,:number_days,:home_address,:house_number, :street_nameNumber,:district, :local_council, :state,:phone,:officer_relieve,:signature_path)";

                $insert_stmt = $conn->prepare($insert_query);

                // DATA BINDING
                  $insert_stmt->bindValue(':staff_id', $staff,PDO::PARAM_INT);
                ...
                $insert_stmt->bindValue(':date_last_leave', htmlspecialchars(strip_tags($dtlast_leave)),PDO::PARAM_STR);
                
                $insert_stmt->bindValue(':date_start_new', $dtStart ,PDO::PARAM_STR);
                
               $insert_stmt->bindValue(':number_days',$numdays,PDO::PARAM_STR);
                $insert_stmt->bindValue(':home_address',$homeAddress,PDO::PARAM_STR);
                
                $insert_stmt->bindValue(':house_number',$houseNum,PDO::PARAM_STR);
                
                 $insert_stmt->bindValue(':street_nameNumber',$street_number,PDO::PARAM_STR);
                  $insert_stmt->bindValue(':district',$district,PDO::PARAM_STR);
                   $insert_stmt->bindValue(':local_council',$lcouncil,PDO::PARAM_STR);
                    $insert_stmt->bindValue(':state',$state,PDO::PARAM_STR);
                     $insert_stmt->bindValue(':phone', $phone,PDO::PARAM_STR);
                     
                       $insert_stmt->bindValue(':officer_relieve',$officeR,PDO::PARAM_STR);
                       
                       $insert_stmt->bindValue(':signature_path',$targetFilePath,PDO::PARAM_STR);
                  ...
                  <tr>
                    <td class=\"content-cell\">
                      <div class=\"f-fallback\">
                        ...
                        <p>STATUS: SENT TO SUPERVISOR</p>
                        <p>Leave application is successfull, sent to supervissor for review 
   </p>
...
$mail->FromName = "nsitf";
//$mail->AddAddress("josh@example.net", "Josh Adams");
$mail->AddAddress("$superEmail");                  // name is optional
$mail->AddReplyTo("ebs@nsitf.gov.ng", "Information");
                  ...
                  <tr>
                    <td class=\"content-cell\">
                      <div class=\"f-fallback\">
                        ...
                        <p>LEAVE APPLICATION REQUEST</p>
                        <p>Leave application sent ! Your EBS account has been created.
