        ...
        <div class="layout-page">
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
             <?php if(isset($_SESSION['hodSuccess'])){ ?>
               <script>alert("Claim acknowledge, Initiating claim processing------ forward to Inspection")</script>
                
                <?php } ?>
                  <?php unset($_SESSION["hodSuccess"]) ?>
               ...
               <script>alert("DTA Approved, Payment processing in account")</script>
                ...
                <?php } ?>
                  <?php unset($_SESSION["accSuccess"]) ?>
                    ...
                    <?php include("components/reviewed_claims.php"); ?>
