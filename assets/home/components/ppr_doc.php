...
$employees = $query->getRows("select a.*, b.staffId, b.firstname, b.lastname from registry_doc as a, staff_tb as b where a.staffId = b.staffId ORDER BY a.registryId desc");
...
?>
         <div class="card">
                <h5 class="card-header" style="font-size:30px;">Documents</h5>
                <div class="card-body">
