                    ...
                    <table id="tabulka_kariet1" class="table ">
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td>
                            <div class="dropdown">
                                  <a href="leave_review1?cert=<?php echo $row['leaveId'] ?>" type="button" class="btn btn-primary" style="color:green;">Edit Review</a>
                                   
                                   
                                     <a href="leave_review1?cert=<?php echo $row['leaveId'] ?>" type="button" class="btn btn-primary" style="color:green">Suspend Review</a>
