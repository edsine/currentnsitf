...
$claim = $query->getRow("select a.*, b.*, c.* from accident_claim as a, employees as b , employer_tb as c where a.employerId= c.employer_id and a.employeeId = b.employee_id and a.claimId = $dtaId ");
        ...
        <?php if($role == 9) {?>
             ...
             <?php }elseif($role == 3){ ?>
                ...
                <div class="col-md-12">
                  ...
                  <div class="card mb-4">
                    <h5 class="card-header">Branch Head Review/Processing</h5>
                    <!-- Account -->
                    
                    
                    <hr class="my-0" />
                    <div class="card-body">
                      <form id="formAccountSettings" action="processor/claims_val" method="POST" >
                          
                       
                        <div class="row">
                          <div class="mb-3 col-md-6">
                            <label for="firstName" class="form-label">Employer</label>
                            <input
                    
                            value="<?php echo $claim['company_name'] ?>" id="html5-date-input"
                              class="form-control"
                              type="text"
                              disabled
                          ...
                          <div class="row">
                          <div class="mb-3 col-md-6">
                            <label for="firstName" class="form-label">Employee FirstName</label>
                            <input
                    
                            value="<?php echo $claim['employee_firstname'] ?>" id="html5-date-input"
                              class="form-control"
                              type="text"
                              disabled
                          ...
                          <div class="mb-3 col-md-6">
                            <label for="firstName" class="form-label">Employee Surname</label>
                            <input
                    
                            value="<?php echo $claim['employee_surname'] ?>" id="html5-date-input"
                              class="form-control"
                              type="text"
                              disabled
                          ...
                          <div class="mb-3 col-md-6">
                            <label for="firstName" class="form-label">Employee MiddleName</label>
                            <input
                    
                            value="<?php echo $claim['employee_middlename'] ?>" id="html5-date-input"
                              class="form-control"
                              type="text"
                              disabled
                           ...
                           <div class="mb-3 col-md-6">
                            ...
                            value="<?php echo $claim['work_id'] ?>" id="html5-date-input"
                              class="form-control"
                              type="text"
                              disabled
                          ...
                          <div class="mb-3 col-md-6">
                            ...
                            value="<?php echo $claim['date_accident'] ?>" id="html5-date-input"
                              class="form-control"
                              type="text"
                              disabled
                          ...
                          <div class="mb-3 col-md-6">
                            ...
                            value="<?php echo $claim['time_accident'] ?>" id="html5-date-input"
                              class="form-control"
                              type="text"
                              disabled
                          ...
                          <div class="mb-3 col-md-6">
                            <label for="organization" class="form-label">Town where accident occurred</label>
                            <input
                              type="text"
                              class="form-control"
                              id="organization"
                           ...
                           <div class="mb-3 col-md-6">
                            <label for="organization" class="form-label">Local Gvt</label>
                            <input
                              type="text"
                              class="form-control"
                              id="organization"
               
                              value="<?php echo $claim['local_gvt'] ?>"
                                   disabled
                            />
                          </div>
                          ...
                          <div class="mb-3 col-md-6">
                           ...
                           <div class="mb-3 col-md-6">
                            <label for="organization" class="form-label">Date employee reported accident</label>
                            <input
                              type="text"
                              class="form-control"
                              id="organization"
                              ...
                              placeholder=""
                              value="<?php echo $claim['acc_report'] ?>"
                                   disabled
                            />
                          </div>
                          
                          <div class="mb-3 col-md-6">
                            <label for="organization" class="form-label">Time employee reported accident</label>
                            <input
                              type="text"
                              class="form-control"
                              id="organization"
               
                              value="<?php echo $claim['time_report'] ?>"
                                   disabled
                            />
                          </div>
                          ...
                          <div class="mb-3 col-md-6">
                            <label for="organization" class="form-label">What task was the employee performing at the time of accident? </label>
                            <input
                              type="text"
                              class="form-control"
                              id="organization"
                  
                              value="<?php echo $claim['task'] ?>"
                                   disabled
                            />
                          </div>
                          ...
                          <div class="mb-3 col-md-6">
                            <label for="organization" class="form-label">Was the accident in the course of his/her work?</label>
                            <input
                              type="text"
                              class="form-control"
                              id="organization"
                              ...
                              placeholder="Number of days"
                              value="<?php echo $claim['course_work'] ?>"
                                   disabled
                            />
                           ...
                           <div class="mb-3 col-md-6">
                            ...
                            <textarea type="text" class="form-control" disabled id="address" name="comment" placeholder="<?php echo $claim['in_nature'] ?>" ></textarea>
                          </div>
                          ...
                          <div class="mb-3 col-md-6">
                            <label for="organization" class="form-label"> Was first aid given in this case?</label>
                            <input
                              type="text"
                              class="form-control"
                              id="organization"
                              ...
                              placeholder="Number of days"
                              value="<?php echo $claim['first_aid'] ?>"
                                   disabled
                            />
                 ...
                 <h6 class="card-header"> Medical practitioner who treated the employee:</h6>
                          <div class="mb-3 col-md-6">
                            <label for="firstName" class="form-label">Surname</label>
                            <input
                    
                            value="<?php echo $claim['mp_lastname'] ?>" id="html5-date-input"
                              class="form-control"
                              type="text"
                              disabled
                          ...
                          <div class="mb-3 col-md-6">
                            ...
                            value="<?php echo $claim['mp_firstname'] ?>" id="html5-date-input"
                              class="form-control"
                              type="text"
                              disabled
                     ...
                     <input type="hidden" name="officer" value="<?php echo $staff; ?>">
                      <input type="hidden" name="claimId" value="<?php echo $dtaId; ?>">
