          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              ...
              <div class="row">
               ...
               <script>alert("Leave review is successful, Leave processing forward to Approval")</script>
                ...
                <!--/ Transactions -->
                          ...
                          <?php if($role == 1 || $role == 6 || $role== 7){ ?>
                        <?php include("components/employee_list.php"); ?>   
                        <?php }elseif($role == 9){ ?>
                          <?php include("components/sup_reviewed.php"); ?>   
                        
                      <?php }elseif($role == 3){?>
                      <?php include("components/hrm_reviewed.php"); ?>  
                      <?php  }elseif($role == 10){ ?>
                        <?php include("components/approvedL.php"); ?>  
