        ...
        try{
             ...
             $update_query = "UPDATE leave_review SET comments =:comments where leave_id =:leave_id";
               ...
               $result = $update_stmt->execute();
                ...
                $update_query3 = "Update leave_request set leave_officer = :leave_officer where leaveId =:leave_id";
                $update_stmt3 = $conn->prepare($update_query3);
                $update_stmt3->bindValue(':leave_officer',$leave_officer,PDO::PARAM_INT);
