    ...
    $stage = 1;
    if ($staff_role == "8") { //USER
      $stage = 1;
    }elseif ($staff_role == "9"){ //SUPERVISOR
      $stage = 2;
    }elseif ($staff_role == "1" || $staff_role == "3") { //MD or HOD
      $stage = 3;
    }elseif ($staff_role == "10"){ //LEAVE PROCESSING OFFICER
      $stage = 4;
    }else{
      $stage = 1;
    }
    ...
    $state =   $_POST['state'] ;
    $phone = $_POST['phone'] ;
    $officer_to_relieve = $_POST['officer_to_relieve'];
    ...
    try{
     ...
     $insert_stmt->bindValue(':officer_to_relieve',$officer_to_relieve,PDO::PARAM_STR);
