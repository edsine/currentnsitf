...
if (!$_POST['spath'] || !$_POST['doc_name'] || !$_POST['doc_desc']) {
  $_SESSION['error'] = "Document name, folder and description required for upload!";
...
try {
  ...
  if ($check_email_stmt->rowCount()) {
    $_SESSION['errors'] = $_SESSION['error'] = "Employer with the following email address already exist";
