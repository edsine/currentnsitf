                  ...
                  <div class="card mb-4">
                    ...
                    <div class="card-body">
                      <form action="./processor/registry_val" method="POST">
                           ...
                           <div class="mb-3">
                          <label class="form-label" for="basic-icon-default-fullname">Documents Related (PDF)</label>
                        ...
                        <div class="mb-3">
                          <label class="form-label" for="basic-icon-default-fullname">Purpose Of Travel</label>
                          <div class="input-group input-group-merge">
                               <span id="basic-icon-default-fullname2" class="input-group-text"
                              ><i class="bx bx-user"></i
                            ></span>
