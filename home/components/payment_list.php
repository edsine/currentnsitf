...
$employees = $query->getRows("select a.*, b.*, c.*  from transactions as a,  employer_tb as b, payment_type as c where a.employerId = b.employer_id and a.payment_type = c.p_typeId and a.approve_status =0 and b.branchId =$branch "); 
...
?>
         <div class="card">
                <h5 class="card-header" style="font-size:30px;"> Payments</h5>
                <div class="card-body">
