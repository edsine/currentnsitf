              ...
              <td>
                <div class="dropdown">
                  ...
                  <div class="dropdown-menu">
                    ...
                    <a class="dropdown-item" href="processor/document_delete.php?id=<?php echo $row['documentId'] ?>&type=doc"><i class="bx bx-trash me-1"></i> Delete</a>
                    <a class="dropdown-item" href="" data-toggle="modal" data-target="#staff_list" id="<?php echo $row['documentId']; ?>"><i class="bx bx-share-alt me-1"></i>Share</a>
                  </div>
                </div>
              </td>
            </tr>

            <div class="modal fade" id="modalLoginForm<?php echo $row['documentId'] ?>fr" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                  ...
                  <form method="post" class="form" action="processor/document_edit.php?doc_dialogue=<?php echo $row['documentId'] ?>" enctype="multipart/form-data">
                    <div class="modal-body">
                      ...
                      <div class="md-form mb-5">
                        ...
                        <i class="fas fa-envelope prefix grey-text"></i>
                        <input type="file" name="doc_file" id="pdffile" class="form-control validate" accept=".pdf">
