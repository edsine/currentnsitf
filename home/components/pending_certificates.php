...
$employees = $query->getRows("select a.*, b.*  from certificate_request as a, employer_tb as b where a.employer_id = b.employer_id and a.branch_id =$branch and a.processing_status = 0"); 
...
?>
         <div class="card">
                <h5 class="card-header" style="font-size:30px;">Pending Certificates Request</h5>
                <div class="card-body">
   ...
   onMouseOut="this.style.color='#fff'"  href="components/app_certificate?cert=<?php echo $row['request_id'] ?>" type="button" class="btn btn-primary">ISSUE CERTIFICATE</a> 
                              <?php }else{ ?>
