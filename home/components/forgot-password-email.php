...
$mail->Subject = "NSITF EBS PASSWORD RESET LINK,";
...
<html xmlns=\"http://www.w3.org/1999/xhtml\">
  ...
  <body>
    <span class=\"preheader\">NATIONAL SOCIAL INSURANCE TRUST FUND EBS PASSWORD RESET</span>
          ...
          <table class=\"email-content\" width=\"100%\" cellpadding=\"0\" cellspacing=\"0\" role=\"presentation\">
            <tr>
              <td class=\"email-masthead\">
                <a href=\"https://www.ebs.nsitf.gov.ng\" class=\"f-fallback email-masthead_name\">
                  ...
                  <tr>
                    <td class=\"content-cell\">
                      <div class=\"f-fallback\">
                        ...
                        <p>Hello,</p>
                        <p>We have received a request to reset the password for the NSITF EBS account associated with [<b>" . $email . "</b>].</p>
                        <p>You can reset your password by clicking the link below:<br/></p>
                        ...
                        <p>Note that it is your responsibility to keep your login credentials secure.</p>
...
if (!$mail->Send()) {
    $_SESSION['error'] = "Email message not sent!";
}
