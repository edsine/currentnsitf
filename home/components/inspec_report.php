...
<?php include("components/sidebar.php"); ?>
                ...
                <!-- Order Statistics -->
                  ...
                  <div class="card mb-4">
                    ...
                    <div class="card-body">
                     ...
                     <p>Submitted Number of Employees : <?php echo $numbeOfemp ?>$ecsnum </p>
                     
                      <p>Compliant Status : <?php echo $numbeOfemp ?>$ecsnum </p>
  ...
  <path d="M7.646 11.854a.5.5 0 0 0 .708 0l3-3a.5.5 0 0 0-.708-.708L8.5 10.293V1.5a.5.5 0 0 0-1 0v8.793L5.354 8.146a.5.5 0 1 0-.708.708l3 3z"/>
                        ...
                        <button type="download" class="btn btn-primary">View/Download Report File</button>
                      </form>
                    </div>
                  </div>
                </div>
