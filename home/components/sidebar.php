 ...
 -->
           ...
           <!--  
            ...
            <li class="menu-item">
              <a href="javascript:void(0);" class="menu-link menu-toggle">
                <i class="menu-icon tf-icons bx bx-dock-top"></i>
                <div data-i18n="Account Settings"  >Electronic Payments</div>
              </a>
              <ul class="menu-sub">
    ...
    <?php }elseif($role == 6){ ?>
      <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
        ...
        <li class="menu-item">
          <a href="javascript:void(0);" class="menu-link menu-toggle">
            <i class="menu-icon tf-icons bx bx-dock-top"></i>
            <div data-i18n="Account Settings">Employer Registration</div>
          </a>
          <ul class="menu-sub">
            <li class="menu-item">
              <a href="employer" class="menu-link">
...
<!--           <li class="menu-item">
   ...
   <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
    ...
    <ul class="menu-inner py-1">
     ...
     <li class="menu-item">
      <a href="javascript:void(0);" class="menu-link menu-toggle">
        <i class="menu-icon tf-icons bx bx-dock-top"></i>
        <div data-i18n="Account Settings" style="">Leave Requests</div>
      </a>
      <ul class="menu-sub">
        <li class="menu-item">
          <a href="leave_rquest" class="menu-link">
        ...
        <li class="menu-item">
          <a href="leave_status" class="menu-link">
            <div data-i18n="Connections" >My Leave Requests</div>
          </a>
        </li>
      </ul>
    </li>
  ...
  <!--   <li class="menu-item">
    ...
    <li class="menu-item">
      <a href="javascript:void(0);" class="menu-link menu-toggle">
        <i class="menu-icon tf-icons bx bx-dock-top"></i>
        <div data-i18n="Account Settings" style="">DTA Requests</div>
      </a>
      <ul class="menu-sub">
        <li class="menu-item">
    ...
    <ul class="menu-sub">
      ...
      <li class="menu-item">
        <a href="s_reviewed" class="menu-link">
          <div data-i18n="Notifications" >Reviewed Leave Requests</div>
        </a>
      </li>
...
<?php }elseif($role == 10){ ?>
    ...
    <ul class="menu-sub">
      ...
      <li class="menu-item">
        <a href="app_request" class="menu-link">
          <div data-i18n="Badges" >New Leave Request</div>
        </a>
      </li>

      <li class="menu-item">
        <a href="approved_leaves" class="menu-link">
          <div data-i18n="Notifications" >Approved Leave Requsts</div>
        </a>
      </li>
  ...
  <li class="menu-item">
      <a href="javascript:void(0);" class="menu-link menu-toggle">
        <i class="menu-icon tf-icons bx bx-dock-top"></i>
        <div data-i18n="Account Settings" style="">DTA Request</div>
      </a>
      <ul class="menu-sub">
        <li class="menu-item">
          <a href="new_dta" class="menu-link">
        ...
        <li class="menu-item">
          <a href="submitted_dtas" class="menu-link">
            <div data-i18n="Notifications" >My DTA Requests</div>
          </a>
        </li>
