          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
                ...
                <div class="" style="width:50%;">
                  <div class="card mb-4">
                    ...
                    <div class="mb-3">
                      ...
                      <option style="color:red;"><span > -Select Deparment- <span style="color:red;">*</span></span></option>
                      <?php
                    ...
                    <div class="mb-3">
                      ...
                      <option style="color:red;"><span > -Select Unit- <span style="color:red;">*</span></span></option>
                    </select>
                  </div>
             ...
             <div class="mb-3">
              ...
              <select   name="gender" id="defaultSelect" class="form-select" required>
            ...
            <div class="mb-3">
              ...
              <div class="input-group input-group-merge">
                ...
                id="basic-icon-default-phone"
                class="form-control phone-mask"
                placeholder="Example: 08067656543"
...
<script>
  $(document).ready(function() {
    ...
    $("#department").change(function(){
      ...
      var datastring = "department= " + department;
       $.ajax({
         url: 'get_units',
         type: 'post',
         data: datastring,
         ...
         success:function(response){
          ...
          for( var i = 0; i<len; i++){
           ...
           $("#units").append("<option value='"+id+"'>"+title+"</option>");
         }
       }
     });
   });
