...
<div class="mb-3">
  ...
  <textarea class="form-control" name="doc_desc" id="exampleFormControlTextarea1" rows="3"></textarea>
</div>
...
?>
                       ...
                       <select  name="toId" id="lastName" class="form-control" />
...
?>
   ...
   <input type="hidden" name="fromId" value="<?php echo $staff ?>">
                   
                     <div class="mb-3">
  <label for="exampleFormControlInput1" class="form-label">Description/Comment</label>
  <textarea type="text" class="form-control" name="comment" id="" placeholder="comment here"></textarea>
</div>
