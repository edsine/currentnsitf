      ...
      <div class="col-12 col-lg-9 col-xl-7">
        <div class="card shadow-2-strong card-registration" style="border-radius: 15px;">
          <div class="card-body p-4 p-md-5">
            ...
            <form  method="post" action="processor/employer_reg" enctype="multipart/form-data">
...
<label class="form-label" for="firstName">Certificate of Incorporation  <span style="color:red;">(PDF Only)*</span></label>
     ...
     <label class="form-label" for="lastName">Other Documents</label>
              ...
              <div class="mt-4 pt-2">
                <input class="btn btn-primary btn-lg" style="background-color:#50664d; border-color:#50664d;"  type="submit" value="Submit" />
              </div>
