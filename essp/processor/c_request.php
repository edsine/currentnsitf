...
$sql = "SELECT a.*, b.*, c.* FROM `request` as a, artisan_tb as b, const_services as c WHERE a.provider_id = b.artisan_id and a.skill_id = c.service_id and a.progress_status = 2 and a.client_id='$post_id'"; 
