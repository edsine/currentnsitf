...
if ($fileSize > 2145728) { // 3 MB (1 byte * 1024 * 1024 * 3 (for 3 MB))
...
require("PHPMailer_5.2.0/class.pop3.php");
  ...
  $mail = new PHPMailer();
        ...
        try{
            ...
            if($check_email_stmt->rowCount()){
              $_SESSION['errors'] = "Employer with the following email address already exist";
                 ...
                 $fetch_ecs = "SELECT ecs_number, employer_id FROM `employer_tb` ORDER BY employer_id DESC limit 1";
            $query_stmt = $conn->prepare($fetch_ecs);
        ...
        if(move_uploaded_file($_FILES["doc"]["tmp_name"], $targetFilePath)){
                ...
                $insert_query = "INSERT INTO `employer_tb`(ecs_number,`company_name`, `rc_number`, `cac_date`,address, postal_address, state, local_gvt, c_email, password, desk_surname,`desk_middlename`, `desk_firstname`, `desk_phone`, `desk_position`, `nin`, `bussiness_area`, `branchId`, regionId )VALUES(:ecs,:cname,
                ...
                // DATA BINDING
                  ...
                  $insert_stmt->bindValue(':ecs', htmlspecialchars(strip_tags($newEcs)),PDO::PARAM_STR);
                            ...
                            <table border=\"0\" align=\"center\" width=\"590\" cellpadding=\"0\" cellspacing=\"0\" class=\"container590\">
                                ...
                                <tr>
                                    <td align=\"center\" height=\"70\" style=\"height:70px;\">
                                        <a href=\"\" style=\"display: block; border-style: none !important; border: 0 !important;\"><img width=\"100\" border=\"0\" style=\"display: block; width: 100px;\"  alt=\"\" /></a>
                                    </td>
                                </tr>
                            </table>
                        </td>
                    ...
                    <tr>
                        <td align=\"center\" style=\"color: #343434; font-size: 24px; font-family: Quicksand, Calibri, sans-serif; font-weight:700;letter-spacing: 3px; line-height: 35px;\" class=\"main-header\">
                            ...
                            <div style=\"line-height: 35px\">
                                ...
                                WELLCOME <span style=\"color: #5caad2;\">TO NSITF EMPLOYERS PORTAL</span>
