...
///home/ensitfco/public_html/mailer/PHPMailer_5.2.0.zip

require("/home/ensitfco/public_html/mailer/PHPMailer_5.2.0/class.phpmailer.php");
require("/home/ensitfco/public_html/mailer/PHPMailer_5.2.0/class.smtp.php");
require("/home/ensitfco/public_html/mailer/PHPMailer_5.2.0/class.pop3.php");
  ...
  $mail = new PHPMailer();
            ...
            //     $nin =  $_POST['nin'];
                ...
                $lsalary =    $_POST['lsalary'] ;
                  $mcontribution =   $_POST['mcontribution'] ;
                   $incident_desc =   $_POST['incident_desc'];
                 $incident_date = $_POST['inc_date'] ;
                $incident_time =   $_POST['inc_time'];
                $employerAcc_name =   $_POST['employer_accnName'];
                $employerAcc_num =  $_POST['employer_accnNum'];
                $employer_bank =  $_POST['employer_bank'];
                $employer_sCode = $_POST['employer_sCode'];
                  $employee_accName =  $_POST['employee_accName'];
                 $employee_accNumb =  $_POST['employee_accNumb'];
                 $employee_bank =  $_POST['employee_bank'];
                 $employee_sortCode =  $_POST['employee_sortCode'];
   ...
   $allowTypes = array('jpg','png','jpeg','pdf');
        ...
        if(move_uploaded_file($_FILES["doc"]["tmp_name"], $targetFilePath)){
                ...
                $insert_query = "INSERT INTO `claims_tb`(`employeeId`,employer_id,`last_salary`, `monthly_contribution`, `incident_description`, `incident_date`, `incident_time`, `employer_accName`, `employer_accNumb`, `employer_bank`, `employer_sortCode`, `employee_accName`, `employee_accNumb`, `employee_bank`, `employee_sortCode`)VALUES(:employeeId,:employer_id,
                :last_salary,:monthly_contribution, :incident_description, :incident_date,:incident_time, :employer_accName, :employer_accNumb, :employer_bank, :employer_sortCode, :employee_accName, :employee_accNumb, :employee_bank,:employee_sortCode )";
                ...
                $insert_stmt->bindValue(':last_salary', htmlspecialchars(strip_tags( $lsalary)),PDO::PARAM_STR);
                $insert_stmt->bindValue(':monthly_contribution',   $mcontribution,PDO::PARAM_STR);
               $insert_stmt->bindValue(':incident_description',$incident_desc,PDO::PARAM_STR);
               
               $insert_stmt->bindValue(':incident_date', htmlspecialchars(strip_tags($incident_date)),PDO::PARAM_STR);
                $insert_stmt->bindValue(':incident_time', $incident_time ,PDO::PARAM_STR);
                
                 $insert_stmt->bindValue(':employer_accName', htmlspecialchars(strip_tags($employerAcc_name)),PDO::PARAM_STR);
                $insert_stmt->bindValue(':employer_accNumb',  $employerAcc_num,PDO::PARAM_STR);
                
                
                  $insert_stmt->bindValue(':employer_bank', htmlspecialchars(strip_tags( $employer_bank)),PDO::PARAM_STR);
                  
                  
                 $insert_stmt->bindValue(':employer_sortCode',  $employer_sCode,PDO::PARAM_STR);
                   $insert_stmt->bindValue(':employee_accName',$employee_accName,PDO::PARAM_STR);
                   $insert_stmt->bindValue(':employee_accNumb',   $employee_accNumb,PDO::PARAM_STR);
                    
                    
                     $insert_stmt->bindValue(':employee_bank',     $employee_bank,PDO::PARAM_STR);
                      $insert_stmt->bindValue(':employee_sortCode',  $employee_sortCode,PDO::PARAM_STR);
...
$mail->Host = "ensitf.com.ng";  // specify main and backup server
$mail->SMTPAuth = true;     // turn on SMTP authentication
$mail->Username = "
info@ensitf.com.ng";  // SMTP username
$mail->Password = "2338@Hajara"; // SMTP password

$mail->From = "
info@ensitf.com.ng";
$mail->FromName = "ensitf";
//$mail->AddAddress("josh@example.net", "Josh Adams");
$mail->AddAddress("$cemail");                  // name is optional
$mail->AddReplyTo("
info@ensitf.com.ng", "Information");
