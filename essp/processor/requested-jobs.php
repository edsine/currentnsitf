...
$sql = "select a.*, b.*, c.* from request as a, artisan_tb as b, const_services as c where a.client_id = b.artisan_id and a.skill_id =c.service_id and a.provider_id=$id and a.progress_status = 2 order by a.request_id "; 
