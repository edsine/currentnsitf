...
$sql = "select a.*, b.*, c.* from request as a, artisan_tb as b, const_services as c where a.skill_id =c.service_id and a.client_id=b.artisan_id and a.provider_id=$id  and a.progress_status=1 and payment_status =1 order by a.request_id desc "; 
