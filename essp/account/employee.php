...
$employer = $_SESSION['employerId'] ;
 ...
 $conn = new mysqli('178.159.5.249', 'ensitfco_nuru', 'ebs@nsitf', 'nsitfmai_ebs2');
              ...
              <div class="row">
                <!-- Order Statistics -->
                  ...
                  <div class="card mb-4">
                    ...
                    <p style="color:green;"> <?php if(isset($_SESSION['success'])){ echo $_SESSION['success']; } ?></p>
                    </div>
                    ...
                    <div class="card-body">
                      <form method="post", action="../processor/new_employee">
                           ...
                           <input
                              type="hidden"
                              name="employer"
                              value="<?php echo $_SESSION['employerId'] ?>"
                              class="form-control"
                        ...
                        <div class="col-md-10">
                          <input name="dob" class="form-control" type="date" value="2021-06-18" id="html5-date-input" />
                        </div>
                      </div>
                       <div class="mb-3">
                        ...
                        <div class="col-md-10">
                          <input name="emp_date" class="form-control" type="date" value="2021-06-18" id="html5-date-input" />
                        </div>
                      </div>
                        <div class="mb-3">
...
?>
                      ...
                      <div class="mb-3">
                          ...
                          <div class="input-group input-group-merge">
                            ...
                            <input
                             name="monhtly_rem"
                              ...
                              id="basic-icon-default-company"
                              class="form-control"
                             placeholder="Remuneration In Naira"
                        ...
                        <button type="submit" class="btn btn-primary" style="background-color:#50664d;">Add</button>
                      </form>
